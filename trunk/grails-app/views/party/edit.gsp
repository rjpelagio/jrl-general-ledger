...
<html>
    ...
    <body>
        ...
        <div class="body"  style="width:75%">
            ...
            <g:form method="post" >
                <g:hiddenField name="empId" value="${payeeData?.empId}" />
                <g:hiddenField name="version" value="${payeeData?.version}" />
                <g:hiddenField name="partyId" value="${payeeData?.partyId}"/>
                <g:hiddenField name="personId" value="${payeeData?.personId}"/>

                <g:hiddenField name="postalAddressId" value="${payeeData?.postalAddressId}"/>
                <g:hiddenField name="telInfoId" value="${payeeData?.telInfoId}"/>
                <g:hiddenField name="contactPerson" value="${payeeData?.contactPerson}"/>
                <g:hiddenField name="elecAddressId" value="${payeeData?.elecAddressId}"/>
                    ...
                    <table border='1'>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: payeeData, field: 'Status', 'errors')}">
                                    <g:select name="status" from="${payeeData.constraints.status.inList}" 
                                        value="${payeeData?.status}"  />
