...
<html>
    ...
    <body>
        ...
        <div class="body">
            <h1><g:message code="cashAdvanceSummary.label" /></h1>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:150px" colspan="2">
                                    ...
                                    <form class="jasperReport" name="CashAdvance" action="/jrl/jasper/">
                                        <input type="hidden" name="_format" value="PDF">
                                        <input type="hidden" name="_name" value="Cash Advance ${new Date()}">
                                        <input type="hidden" name="_file" value="CashAdvanceSummary">
