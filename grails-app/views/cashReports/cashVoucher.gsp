...
<html>
    <head>
        ...
        <title>Petty Cash Voucher Reports</title>
    ...
    <body>
        ...
        <div class="body">
            <h1><g:message code="cashVoucherReport.label" /></h1>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:150px" colspan="2">
                                    ...
                                    <form class="jasperReport" name="CashVoucher" action="/jrl/jasper/">
                                        <input type="hidden" name="_format" value="PDF">
                                        <input type="hidden" name="_name" value="Cash Voucher ${new Date()}">
                                        <input type="hidden" name="_file" value="CashVoucher">
                                ...
                                <td>
                                    <!--
                                    <g:jasperReport jasper="CashVoucher" format="PDF,XLS" name="CashVoucher">
                                        <input type="hidden" name="logged_user" value="1">
                                        <input type="hidden" name="orgcode" value="1">
                                        <input type="hidden" id="from_date" name="from_date" value="">
                                        <input type="hidden" id="thru_date" name="thru_date" value="">
