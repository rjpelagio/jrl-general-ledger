...
<html>
    <head>
        ...
        <title>Replenishment Summary</title>
    ...
    <body>
        ...
        <div class="body">
            <h1><g:message code="replenishmentSummary.label" /></h1>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding-left:150px" colspan="2">
                                    ...
                                    <form class="jasperReport" name="ReplenishmentSummary" action="/jrl/jasper/">
                                        <input type="hidden" name="_format" value="PDF">
                                        <input type="hidden" name="_name" value="Replenishment Summary ${new Date()}">
                                        <input type="hidden" name="_file" value="ReplenishmentSummary">
