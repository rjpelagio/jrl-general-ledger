...
<html>
    <head>
        ...
        <title>General Ledger History Report</title>
        <script>
    ...
    <body>
      <div class="body">
        ...
        <g:jasperReport jasper="GLHistory" format="PDF" name="General Ledger History">
          ...
          <input type="hidden" id="from_date" name="from_date" value="${com.gl.AcctgPeriod.get(1).fromDate}"/>
          <input type="hidden" id="thru_date" name="thru_date" value="${com.gl.AcctgPeriod.get(1).thruDate}"/>
        </g:jasperReport>
      </div>
    </body>
</html>