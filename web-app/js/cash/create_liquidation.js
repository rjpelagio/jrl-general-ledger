            ...
            function recomputeAmount(index) {
                ...
                var voucherAmount = parseFloat($("#voucherAmount").val());
                ...
                for (i = 0; i < amounts.length; i++) {
                    ...
                    if (totalAmount > voucherAmount) {
                        alert ("Total amount must not be greater than the Voucher amount.")
                         totalAmount = totalAmount - parseFloat($("#amount_"+index).val())
                        $("#amount_"+index).val('0');
                    }
                }
